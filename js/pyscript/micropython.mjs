...
["_mp_js_init","_mp_js_init_repl","_mp_js_do_str","_mp_js_process_char","_mp_hal_get_interrupt_char","_mp_sched_keyboard_interrupt","_malloc","_free","_mp_js_do_exec","_mp_js_do_exec_async","_mp_js_do_import","_mp_js_register_js_module","_mp_obj_jsobj_callback_proxy","_convert_mp_to_js_obj_cside","_proxy_c_init","_proxy_c_to_js_call","_proxy_c_to_js_lookup_attr","_proxy_c_to_js_get_type","_proxy_c_to_js_get_dict","_proxy_c_to_js_get_array","_memory","___indirect_function_table","_has_attr","_lookup_attr","_store_attr","_call0","_call1","_call2","_calln","_call0_kwarg","_call1_kwarg","_js_reflect_construct","_js_get_len","_js_subscr_int","_js_subscr_load","_js_subscr_store","_js_then_resolve","_js_then_reject","_js_then_continue","_js_callable_proxy","_fflush","___start_em_js","___stop_em_js","onRuntimeInitialized"].forEach((prop) => {
...
function call0(f_ref,out) { const f = proxy_js_ref[f_ref]; const ret = f(); convert_js_to_mp_obj_jsside(ret, out); }
function call1(f_ref,a0,out) { const a0_js = convert_mp_to_js_obj_jsside(a0); const f = proxy_js_ref[f_ref]; const ret = f(a0_js); convert_js_to_mp_obj_jsside(ret, out); }
function call2(f_ref,a0,a1,out) { const a0_js = convert_mp_to_js_obj_jsside(a0); const a1_js = convert_mp_to_js_obj_jsside(a1); const f = proxy_js_ref[f_ref]; const ret = f(a0_js, a1_js); convert_js_to_mp_obj_jsside(ret, out); }
function calln(f_ref,n_args,value,out) { const f = proxy_js_ref[f_ref]; const a = []; for (let i = 0; i < n_args; ++i) { const v = convert_mp_to_js_obj_jsside(value + i * 3 * 4); a.push(v); } const ret = f(...a); convert_js_to_mp_obj_jsside(ret, out); }
function call0_kwarg(f_ref,n_kw,key,value,out) { const f = proxy_js_ref[f_ref]; const a = {}; for (let i = 0; i < n_kw; ++i) { const k = UTF8ToString(getValue(key + i * 4, "i32")); const v = convert_mp_to_js_obj_jsside(value + i * 3 * 4); a[k] = v; } const ret = f(a); convert_js_to_mp_obj_jsside(ret, out); }
function call1_kwarg(f_ref,arg0,n_kw,key,value,out) { const f = proxy_js_ref[f_ref]; const a0 = convert_mp_to_js_obj_jsside(arg0); const a = {}; for (let i = 0; i < n_kw; ++i) { const k = UTF8ToString(getValue(key + i * 4, "i32")); const v = convert_mp_to_js_obj_jsside(value + i * 3 * 4); a[k] = v; } const ret = f(a0, a); convert_js_to_mp_obj_jsside(ret, out); }
...
function js_subscr_int(f_ref,idx,out) { const f = proxy_js_ref[f_ref]; const ret = f[idx]; convert_js_to_mp_obj_jsside(ret, out); }
...
function js_subscr_store(f_ref,idx,value) { const f = proxy_js_ref[f_ref]; f[convert_mp_to_js_obj_jsside(idx)] = convert_mp_to_js_obj_jsside(value); }
function js_then_resolve(resolve,reject) { const resolve_js = convert_mp_to_js_obj_jsside(resolve); const reject_js = convert_mp_to_js_obj_jsside(reject); resolve_js(null); }
function js_then_reject(resolve,reject) { const resolve_js = convert_mp_to_js_obj_jsside(resolve); const reject_js = convert_mp_to_js_obj_jsside(reject); reject_js(null); }
function js_then_continue(jsref,py_resume,resolve,reject,out) { const py_resume_js = convert_mp_to_js_obj_jsside(py_resume); const resolve_js = convert_mp_to_js_obj_jsside(resolve); const reject_js = convert_mp_to_js_obj_jsside(reject); const ret = proxy_js_ref[jsref].then((x) => {py_resume_js(x, resolve_js, reject_js);}, reject_js); convert_js_to_mp_obj_jsside(ret, out); }
function js_callable_proxy(callable,out) { const callback = function(js0, js1) { console.log('js_callable_proxy', js0, js1); let out2 = 0; if (js0 !== undefined) { out2 = _malloc(3 * 4); convert_js_to_mp_obj_jsside(js0, out2); } const out3 = _malloc(3 * 4); ccall("mp_obj_jsobj_callback_proxy", "number", ["pointer", "pointer", "pointer"], [callable, out2, out3]); if (out2 != 0) { _free(out2); } const ret = convert_mp_to_js_obj_jsside(out3); _free(out3); return ret; }; convert_js_to_mp_obj_jsside(callback, out); }
...
var _convert_mp_to_js_obj_cside = Module['_convert_mp_to_js_obj_cside'] = createExportWrapper('convert_mp_to_js_obj_cside');
...
var _mp_obj_jsobj_callback_proxy = Module['_mp_obj_jsobj_callback_proxy'] = createExportWrapper('mp_obj_jsobj_callback_proxy');
...
var ___start_em_js = Module['___start_em_js'] = 170856;
var ___stop_em_js = Module['___stop_em_js'] = 175255;
...
;
export default _createMicroPythonModule;export async function loadMicroPython(options) {
...
class PyProxy {
    ...
    static toJs(js_obj) {
        ...
        if (type == 1 || type == 2) {
            ...
            const js_array = [];
            for (let i = 0; i < len; ++i) {
                Module.ccall("convert_mp_to_js_obj_cside", "null", ["pointer", "pointer"], [Module.getValue(items_ptr + i * 4, "i32"), item]);
                const js_item = convert_mp_to_js_obj_jsside(item)
            ...
            for (let i = 0; i < alloc; ++i) {
                ...
                if (mp_key > 8) {
                    ...
                    Module.ccall("convert_mp_to_js_obj_cside", "null", ["pointer", "pointer"], [mp_key, item]);
                    const js_key = convert_mp_to_js_obj_jsside(item)

                    // Convert value to JS object.
                    const mp_value = Module.getValue(table_ptr + i * 8 + 4, "i32");
                    Module.ccall("convert_mp_to_js_obj_cside", "null", ["pointer", "pointer"], [mp_value, item]);
                    const js_value = convert_mp_to_js_obj_jsside(item)
